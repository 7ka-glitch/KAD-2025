...
#define IN_CODE_TABLE {\
	...
	IN::S, IN::F, IN::T, IN::V, IN::F, IN::F, IN::F, IN::F, IN::V, IN::V, IN::V, IN::V, IN::V, IN::V, IN::F, IN::V,\
	IN::N, IN::N, IN::N, IN::N, IN::N, IN::N, IN::N, IN::N, IN::N, IN::N, IN::T, IN::V, IN::F, IN::V, IN::F, IN::F,\
