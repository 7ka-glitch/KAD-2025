...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = // таблица ошибок
	{
		...
		ERROR_ENTRY(111, "Нет закрывающей кавычки строкового литерала (-in)"),
		...
		ERROR_ENTRY(603, "Неверный оператор в выражении"),
		ERROR_ENTRY(604, "Ошибка в определении функции"),
		ERROR_ENTRY(605, "Неверные аргументы вызова функции"),
		...
		ERROR_ENTRY(706, "Счетчик цикла указан неверно"),
		ERROR_ENTRY(707, "Превышено число параметров функции"),
	...
	ERROR geterrorin(int id, int line = -1, int col = -1)
	{
		...
		if (id > 600)
		{
			errors[id-14].inext.line = line;
			errors[id-14].inext.col = col;
			return errors[id - 14];
		}
		return errors[id];
	}
